...
from RAISoft.instruments.Keithley import Electrometer617, Electrometer6517, SM2602_channel, SM2602_FET, SM2602_4PP
...
class ElectrometerA(Electrometer6517):
    def __init__(self):
        MAVmask=16
        IfaceReadyMask=0
        GPIBAddr = 27
...
class ElectrometerB(Electrometer6517):
    def __init__(self):
        MAVmask=16
        IfaceReadyMask=0
        GPIBAddr = 13
